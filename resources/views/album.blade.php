  ...
  <body>
    <div class="container">
      <div class="album-info">
        <div class="album-img">
          <img
            src="{{ asset('storage/fronts/' . $album->front) }}"
            alt=""
          />
        </div>
      ...
      <div class="album-tracks"> 
        ...
        <div class="track song" data-song-src="{{ asset('storage/songs/' . $song->song_route) }}">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        songs.forEach(function(song) {
          ...
          song.addEventListener('click', function(e) {
            ...
            // Para el autor, debes agregar una propiedad real si la tienes
      ...
      // Variables de control de audio y tiempo
